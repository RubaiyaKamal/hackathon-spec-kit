<!--
Sync Impact Report:
Version change: pre-v1.0 → v1.0
Modified principles: All principles updated/defined.
Added sections: All sections from the new constitution.
Removed sections: N/A (assuming initial creation or full replacement of generic template).
...
- README.md (⚠ pending)
Follow-up TODOs:
- Review and update all listed templates and README.md for consistency with the new constitution.
-->
